...
fn bindgen_test_layout_FLAC__IOCallbacks() {
    ...
    assert_eq!(
        ...
        48usize,
        "Size of FLAC__IOCallbacks"
    );
    assert_eq!(
        ::core::mem::align_of::<FLAC__IOCallbacks>(),
        8usize,
        "Alignment of FLAC__IOCallbacks"
    );
    assert_eq!(
...
fn bindgen_test_layout_FLAC__EntropyCodingMethod_PartitionedRiceContents() {
    ...
    assert_eq!(
        ...
        0usize,
        "Offset of field: FLAC__EntropyCodingMethod_PartitionedRiceContents::parameters"
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).raw_bits) as usize - ptr as usize },
        8usize,
        "Offset of field: FLAC__EntropyCodingMethod_PartitionedRiceContents::raw_bits"
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).capacity_by_order) as usize - ptr as usize },
        16usize,
        "Offset of field: FLAC__EntropyCodingMethod_PartitionedRiceContents::capacity_by_order"
    );
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
fn bindgen_test_layout_FLAC__EntropyCodingMethod__bindgen_ty_1() {
    ...
    assert_eq!(
        ...
        0usize,
        "Offset of field: FLAC__EntropyCodingMethod__bindgen_ty_1::partitioned_rice"
    );
}
#[test]
...
fn bindgen_test_layout_FLAC__Subframe_Constant() {
    ...
    assert_eq!(
        ...
        8usize,
        "Size of FLAC__Subframe_Constant"
    );
    assert_eq!(
...
fn bindgen_test_layout_FLAC__Subframe_Fixed() {
    ...
    assert_eq!(
        ...
        72usize,
        "Size of FLAC__Subframe_Fixed"
    );
    assert_eq!(
        ::core::mem::align_of::<FLAC__Subframe_Fixed>(),
        8usize,
        "Alignment of FLAC__Subframe_Fixed"
    );
    assert_eq!(
...
fn bindgen_test_layout_FLAC__Subframe_LPC() {
    ...
    assert_eq!(
        ...
        432usize,
        "Size of FLAC__Subframe_LPC"
    );
    assert_eq!(
        ::core::mem::align_of::<FLAC__Subframe_LPC>(),
        8usize,
        "Alignment of FLAC__Subframe_LPC"
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).entropy_coding_method) as usize - ptr as usize },
        0usize,
...
fn bindgen_test_layout_FLAC__Subframe() {
    ...
    assert_eq!(
        ...
        448usize,
        "Size of FLAC__Subframe"
    );
    assert_eq!(
        ::core::mem::align_of::<FLAC__Subframe>(),
        8usize,
        "Alignment of FLAC__Subframe"
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).type_) as usize - ptr as usize },
        0usize,
...
fn bindgen_test_layout_FLAC__FrameHeader() {
    ...
    assert_eq!(
        ...
        40usize,
        "Size of FLAC__FrameHeader"
    );
    assert_eq!(
        ::core::mem::align_of::<FLAC__FrameHeader>(),
        8usize,
        "Alignment of FLAC__FrameHeader"
    );
    assert_eq!(
...
fn bindgen_test_layout_FLAC__FrameFooter() {
    ...
    assert_eq!(
        ...
        2usize,
        "Size of FLAC__FrameFooter"
    );
    assert_eq!(
        ::core::mem::align_of::<FLAC__FrameFooter>(),
        2usize,
        "Alignment of FLAC__FrameFooter"
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).crc) as usize - ptr as usize },
        0usize,
...
fn bindgen_test_layout_FLAC__Frame() {
    ...
    assert_eq!(
        ...
        8usize,
        "Alignment of FLAC__Frame"
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).header) as usize - ptr as usize },
        0usize,
        "Offset of field: FLAC__Frame::header"
    );
    assert_eq!(
...
fn bindgen_test_layout_FLAC__StreamMetadata() {
    ...
    assert_eq!(
        ...
        176usize,
        "Size of FLAC__StreamMetadata"
    );
    assert_eq!(
        ::core::mem::align_of::<FLAC__StreamMetadata>(),
        8usize,
        "Alignment of FLAC__StreamMetadata"
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).type_) as usize - ptr as usize },
        0usize,
...
fn bindgen_test_layout_FLAC__StreamDecoder() {
    ...
    assert_eq!(
        ...
        16usize,
        "Size of FLAC__StreamDecoder"
    );
    assert_eq!(
        ::core::mem::align_of::<FLAC__StreamDecoder>(),
        8usize,
        "Alignment of FLAC__StreamDecoder"
    );
    assert_eq!(
...
fn bindgen_test_layout_FLAC__StreamEncoder() {
    ...
    assert_eq!(
        ...
        16usize,
        "Size of FLAC__StreamEncoder"
    );
    assert_eq!(
        ::core::mem::align_of::<FLAC__StreamEncoder>(),
        8usize,
        "Alignment of FLAC__StreamEncoder"
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).protected_) as usize - ptr as usize },
        0usize,
